...
data "aws_route53_zone" "zone" {
    name = "ganga888.online" #Change this to your domain name as yours.
}

resource "aws_route53_record" "traefik" {
    zone_id = data.aws_route53_zone.zone.zone_id
    name    = "traefik.ganga888.online"
    type    = "CNAME"
    ttl     = 300
